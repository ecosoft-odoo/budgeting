...
2.  Create new activity, select a KPI (if you want to group it) and
    match the activity to an account.
...
6.  When you select a KPI, it will automatically select the
    corresponding activity and account. If you haven't set up an
    activity in the KPI, you can select the activity and it will
