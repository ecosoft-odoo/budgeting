...
class AccountPaymentRegister(models.TransientModel):
    ...
    def _compute_default_job_order(self):
        ...
        for rec in self:
            rec.deduct_job_order_id = len(job_order) == 1 and job_order.id or False
    ...
    def _prepare_deduct_move_line(self, deduct):
        ...
        vals.update(
            {"job_order_id": deduct.job_order_id and deduct.job_order_id.id or False}
        )
        return vals
    ...
    def _create_payment_vals_from_wizard(self):
        ...
        if (
            ...
            payment_vals["write_off_line_vals"]["job_order_id"] = self.job_order_id.id
        return payment_vals
